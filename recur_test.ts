...
Deno.test("The FREQ rule part is REQUIRED",
    () => {
        assertThrows(() => {
            const re = new RecurrenceRule("BYDAY=MO", start);
        }, Error);
    });
...
Deno.test("UNTIL and COUNT MUST NOT occur in the same 'recur'",
    () => {
        assertThrows(() => {
            const re = new RecurrenceRule("FREQ=DAILY;UNTIL=20200101;COUNT=10", start);            
...
Deno.test({
    ...
    fn: () => {
        assertThrows(() => {
            const re = new RecurrenceRule("FREQ=MANTHLY;BYDAY=MO,TU,WE,TH,FR;BYSETPOS=-1", start);
        }, Error);
    }
})
...
Deno.test({
    ...
    fn: () => {
        const re = new RecurrenceRule("FREQ=MONTHLY;BYDAY=MO,TU,WE,TH,FR;BYSETPOS=-1", start);
...
Deno.test({
    name: "A valid recurrence event is valid",
    fn: () => {
        const re = new RecurrenceRule("FREQ=DAILY;COUNT=10;INTERVAL=2", start);
        assertEquals(re.isValid, true);
    }
});
...
Deno.test({
    name: "A valid recurrence event is valid",
    fn: () => {
        const re = new RecurrenceRule("FREQ=YEARLY;INTERVAL=2;BYMONTH=1;BYDAY=SU;BYHOUR=8,9;BYMINUTE=30", start);
        assertEquals(re.isValid, true);
    }
});
...
Deno.test("The BYDAY rule part MUST NOT be specified with a numeric value when the FREQ rule part is not set to MONTHLY or YEARLY",
    () => {
        assertThrows(() =>{
            const re = new RecurrenceRule("FREQ=DAILY;BYDAY=+1MO", start);
...
Deno.test({
    ...
    fn: () => {
        const re = new RecurrenceRule("FREQ=DAILY;BYDAY=MO", start);
        assertEquals(re.isValid, true);
    }
});
...
Deno.test({
    ...
    fn: () => {
        ...
        const re = new RecurrenceRule("FREQ=DAILY;COUNT=10;BYMONTH=5", start);
...
Deno.test({
    ...
    fn: () => {
        //const re = new RecurrenceRule("FREQ=DAILY;INTERVAL=1;BYDAY=SU;BYHOUR=8,9;BYMINUTE=30;BYSETPOS=-1", start);
        const re = new RecurrenceRule("FREQ=MONTHLY;COUNT=20", "2021-05-28T12:00:00-0500");
        
        //const re = new RecurrenceRule("FREQ=YEARLY;INTERVAL=1;BYMONTH=1,2,3;BYWEEKNO=52;BYYEARDAY=150,151,152;COUNT=50", start);
